...
assert(planJson.withPriceCount === 28, 'Planner reports 28 hotels with priceFrom');
assert(planJson.withoutPriceCount === 8, 'Planner reports 8 hotels missing priceFrom');
assert(planJson.paymentReadyCount === 28, 'Planner reports 28 payment-ready hotels');
assert(planJson.needsAdminPriceCount === 8, 'Planner reports 8 hotels needing admin price');
...
assert(planJson.paymentReadyHotels.length === 28, 'Planner lists 28 payment-ready hotels');
assert(planJson.needsAdminPriceHotels.length === 8, 'Planner lists 8 hotels needing admin price');
