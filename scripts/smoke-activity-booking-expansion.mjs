...
async function main() {
  ...
  try {
    ...
    await customerPage.goto(`${BASE_URL}/activity/activity-grid`, { waitUntil: 'domcontentloaded' });
    ...
    await customerPage.goto(`${BASE_URL}/activity/activity-details?id=${activityId}`, { waitUntil: 'domcontentloaded' });
    await customerPage.waitForTimeout(5000);
    ...
    await customerPage.waitForURL((url) => url.toString().includes('/user/customer-activities-booking'), { timeout: 30000 });
