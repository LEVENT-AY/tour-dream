    ...
    <section className="section place-section bg-white">
      <div className="container">
        ...
        <div className="tab-content">
              ...
              <Slider {...placeSectionSlick}>
                ...
                <div className="place-item mb-4">
                  <div className="place-img">
                    ...
                    <div className="fav-item">
                      <div className="d-flex align-items-center">
                        <Link to="#" className="fav-icon selected me-2">
                          <i className="isax isax-heart5" />
                        </Link>
                        <span className="badge bg-indigo">Cheapest</span>
                      </div>
              ...
              <Slider {...placeSectionSlick}>
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <p className="d-flex align-items-center mb-3">
                      <i className="isax isax-location5 me-2"></i>Ciutat Vella,
                      Barcelona
                    </p>
                    <div className="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                      <div className="pe-4 border-end">
                        <span className="fs-14 d-flex align-items-center text-dark">
                          <i className="isax isax-gas-station me-1"></i>Fuel
                        </span>
                        <p className="text-dark fs-14">Hybrid</p>
                      </div>
                      <div className="pe-4 border-end">
                        <span className="fs-14 d-flex align-items-center text-dark">
                          <i className="isax isax-kanban me-1"></i>Gear
                        </span>
                        <p className="text-dark fs-14">Manual</p>
                      </div>
                      <div>
                        <span className="fs-14 d-flex align-items-center text-dark">
                          <i className="isax isax-routing-2 me-1"></i>Travelled
                        </span>
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <p className="d-flex align-items-center mb-3">
                      <i className="isax isax-location5 me-2"></i>Oxford Street,
                      London
                    </p>
                    <div className="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                      <div className="pe-4 border-end">
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <p className="d-flex align-items-center mb-3">
                      <i className="isax isax-location5 me-2"></i>Princes
                      Street, Edinburgh
                    </p>
                    <div className="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                      <div className="pe-4 border-end">
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <p className="d-flex align-items-center mb-3">
                      <i className="isax isax-location5 me-2"></i>King’s Road,
                      Chelsea
                    </p>
                    <div className="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                      <div className="pe-4 border-end">
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <p className="d-flex align-items-center mb-3">
                      <i className="isax isax-location5 me-2"></i>Bold Street,
                      Liverpool
                    </p>
                    <div className="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                      <div className="pe-4 border-end">
                  ...
                  <div className="place-content">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      <div>
                        ...
                        <p>
                          <i className="isax isax-user me-1"></i>Guests :{" "}
                      ...
                      <div>
                        ...
                        <p>
                          <i className="isax isax-flash-1 me-1"></i>Speed :{" "}
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      <div>
                        <p className="mb-1">
                          <i className="isax isax-calendar-2 text-gray-6 me-1"></i>
                          Year :{" "}
                          <span className="text-dark fw-medium">2018</span>
                        </p>
                        <p>
                          <i className="isax isax-user me-1"></i>Guests :{" "}
                          <span className="text-dark fw-medium">3</span>
              ...
              <Slider {...placeSectionSlick}>
                    ...
                    <div className="d-flex align-items-center justify-content-between border-top pt-3">
                      ...
                      <div className="ms-2 d-flex align-items-center">
                        <p className="fs-14 text-gray-9 mb-0 text-truncate d-flex align-items-center">
                          <i className="isax isax-profile-2user me-1"></i>14
                          Guests
                        </p>
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <div className="d-flex align-items-center justify-content-between border-top pt-3">
                      ...
                      <div className="ms-2 d-flex align-items-center">
                        <p className="fs-14 text-gray-9 mb-0 text-truncate d-flex align-items-center">
                          <i className="isax isax-profile-2user me-1"></i>12
                          Guests
                        </p>
                        <Link to="#" className="avatar avatar-sm ms-3">
                          <ImageWithBasePath
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <div className="d-flex align-items-center justify-content-between border-top pt-3">
                      ...
                      <div className="ms-2 d-flex align-items-center">
                        <p className="fs-14 text-gray-9 mb-0 text-truncate d-flex align-items-center">
                          <i className="isax isax-profile-2user me-1"></i>16
                          Guests
                        </p>
                        <Link to="#" className="avatar avatar-sm ms-3">
                          <ImageWithBasePath
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <p className="d-flex align-items-center mb-3">
                      <i className="isax isax-location5 me-2"></i>Deansgate,
                      Manchester
                    </p>
                    <div className="mb-3">
                      <h6 className="d-flex align-items-center text-gray-6 fs-14 fw-normal">
                    ...
                    <div className="d-flex align-items-center justify-content-between border-top pt-3">
                      ...
                      <div className="ms-2 d-flex align-items-center">
                        <p className="fs-14 text-gray-9 mb-0 text-truncate d-flex align-items-center">
                          <i className="isax isax-profile-2user me-1"></i>10
                          Guests
                        </p>
                        <Link to="#" className="avatar avatar-sm ms-3">
                          <ImageWithBasePath
                ...
                <div className="place-item mb-4 flex-fill">
                  ...
                  <div className="place-content">
                    ...
                    <div className="d-flex align-items-center justify-content-between border-top pt-3">
                      ...
                      <div className="ms-2 d-flex align-items-center">
                        <p className="fs-14 text-gray-9 mb-0 text-truncate d-flex align-items-center">
                          <i className="isax isax-profile-2user me-1"></i>17
                          Guests
                        </p>
                        <Link to="#" className="avatar avatar-sm ms-3">
                          <ImageWithBasePath
          ...
          {/* Bus List */}
          <div className="tab-pane fade" id="Bus-list">
            <div className="owl-carousel place-slider nav-center">
              <Slider {...placeSectionSlick}>
                {/* 1. Red Bird Luxury */}
                <div className="place-item mb-4 flex-fill bus-grid">
                  <div className="place-img">
                    <Link to={all_routes.busDetails}>
                      <ImageWithBasePath
                        src="assets/img/bus/grid/bus-grid-img-1.jpg"
                        className="img-fluid"
                        alt="img"
                      />
                    </Link>
                  ...
                  <div className="place-content">
                    <h5 className="text-truncate mb-1">
                      <Link to={all_routes.busDetails}>Red Bird Luxury</Link>
                    </h5>
                ...
                <div className="place-item mb-4 flex-fill bus-grid">
                  <div className="place-img">
                    <Link to={all_routes.busDetails}>
                      <ImageWithBasePath
                        src="assets/img/bus/grid/bus-grid-img-2.jpg"
                        className="img-fluid"
                        alt="img"
                      />
                    </Link>
                  ...
                  <div className="place-content">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      <span className="avatar avatar-sm me-2">
                        <ImageWithBasePath src="assets/img/bus/bus-logo-02.svg" />
                      </span>
                    ...
                    <div className="date-info p-2 mb-3">
                      <div className="bus-title d-flex justify-content-between align-items-center">
                        <div className="bus-title-item">
                          <h5 className="fs-14 mb-1">Toronto</h5>
                          <p className="fs-14 text-default">02:25 PM</p>
                        </div>
                        <div className="dot-line">
                          <span>
                            <small className="text-muted">14h 10m</small>
                          </span>
                        </div>
                        <div className="bus-title-item">
                          <h5 className="fs-14 mb-1">Bangkok</h5>
                          <p className="fs-14 text-default">04:15 PM</p>
                        </div>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between align-items-center border-top pt-3">
                      ...
                      <h6 className="text-primary">
                        <span className="fs-14 text-default">From </span>$300
                      </h6>
                    </div>
                  </div>
                </div>
                ...
                <div className="place-item mb-4 flex-fill bus-grid">
                  <div className="place-img">
                    <Link to={all_routes.busDetails}>
                      <ImageWithBasePath
                        src="assets/img/bus/grid/bus-grid-img-3.jpg"
                        className="img-fluid"
                      />
                    </Link>
                    <div className="fav-item">
                  ...
                  <div className="place-content">
                    <h5 className="mb-1">
                      <Link to={all_routes.busDetails}>Urban Glide</Link>
                    </h5>
                    <div className="d-flex mb-3">
                      <span className="avatar avatar-sm me-2">
                        <ImageWithBasePath src="assets/img/bus/bus-logo-03.svg" />
                      </span>
                      <p className="fs-14 me-2 mb-0">Volvo</p>
                      <p className="fs-14">
                        <i className="ti ti-point-filled text-primary me-2" />
                        Sleeper
                      </p>
                    ...
                    <div className="date-info p-2 mb-3">
                      <div className="bus-title d-flex justify-content-between align-items-center">
                        <div>
                          <h5 className="fs-14 mb-1">Dallas</h5>
                          <p className="fs-14 text-default">04:45 PM</p>
                        </div>
                        <div className="dot-line">
                          <span>
                            <small className="text-muted">19h 10m</small>
                          </span>
                        </div>
                        <div>
                          <h5 className="fs-14 mb-1">Atlanta</h5>
                          <p className="fs-14 text-default">08:15 AM</p>
                        </div>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between align-items-center border-top pt-3">
                      ...
                      <h6 className="text-primary">
                        <span className="fs-14 text-default">From </span>$400
                      </h6>
                    </div>
                  </div>
                </div>
                ...
                <div className="place-item mb-4 flex-fill bus-grid">
                  <div className="place-img">
                    <Link to={all_routes.busDetails}>
                      <ImageWithBasePath
                        src="assets/img/bus/grid/bus-grid-img-4.jpg"
                        className="img-fluid"
                      />
                    </Link>
                    <div className="fav-item">
                  ...
                  <div className="place-content">
                    ...
                    <div className="d-flex mb-3">
                      <span className="avatar avatar-sm me-2">
                        <ImageWithBasePath src="assets/img/bus/bus-logo-01.svg" />
                      </span>
                      <p className="fs-14 me-2 mb-0">Tata</p>
                      <p className="fs-14 mb-0">
                        <i className="ti ti-point-filled text-primary me-2" />
                        Seater
                      </p>
                    ...
                    <div className="date-info p-2 mb-3">
                      <div className="bus-title d-flex justify-content-between align-items-center">
                        <div>
                          <h5 className="fs-14 mb-1">New York</h5>
                          <p className="fs-14">07:00 AM</p>
                        </div>
                        <div className="dot-line">
                          <span>
                            <small className="text-muted">11h 10m</small>
                          </span>
                        </div>
                        <div>
                          <h5 className="fs-14 mb-1">Boston</h5>
                          <p className="fs-14">08:25 PM</p>
                        </div>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between align-items-center border-top pt-3">
                ...
                <div className="place-item mb-4 flex-fill bus-grid">
                  <div className="place-img">
                    <Link to={all_routes.busDetails}>
                      <ImageWithBasePath
                        src="assets/img/bus/grid/bus-grid-img-5.jpg"
                        className="img-fluid"
                      />
                    </Link>
                    <div className="fav-item">
                  ...
                  <div className="place-content">
                    ...
                    <div className="date-info p-2 mb-3">
                      <div className="bus-title d-flex justify-content-between align-items-center">
                        <div>
                          <h5 className="mb-1 fs-14">Seattle</h5>
                          <p>06:00 PM</p>
                        </div>
                        <div className="dot-line">
                          <span>
                        ...
                        <div>
                          <h5 className="mb-1 fs-14">Denver</h5>
                          <p>07:20 AM</p>
                        </div>
                      </div>
                    </div>
        ...
        <div className="text-center view-all wow fadeInUp">
          ...
          >
            View All Places<i className="isax isax-arrow-right-3 me-2"></i>
          </Link>
        </div>
      </div>
    </section>
