                    ...
                    <div className="col-xl-5">
                        <div className="footer-widget">
                            <div className="footer-about">
                                <div className="mb-4">
                                    <Link to={routes.home3} className="d-inline-block mb-1">
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-5">
                        <p>Copyright &copy; 2026. All Rights Reserved, <Link to="#" className="text-primary fw-medium">DreamsTour</Link></p>
                    </div>
