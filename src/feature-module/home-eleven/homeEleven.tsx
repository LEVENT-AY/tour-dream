...
import HomeElevenFooter from "./homeElevenFooter";
...
const HomeEleven = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="hero-sec-eleven">
        <div className="container">
          <div className="banner-content wow fadeInUp">
            <h1>
              Discover and Book Incredible Tour Activities Across the World
            </h1>
            <span className="fs-16 fw-medium text-white">
              Explore stunning destinations and world-class experiences aboard
              ...
              <div className="col-md-12 mx-auto">
                ...
                >
                  <div className="card-body p-4">
                    <form action="#">
                      <div className="fw-medium fs-16 mb-2 text-gray-9">
