...
import DynamicFeaturedSections from "./dynamicFeaturedSections";
...
import { fetchHomepageSettings, type HomepageSettings } from "../../core/services/firebaseServices";
...
const HomeOne = () => {
  ...
  useEffect(() => {
    fetchHomepageSettings().then((s) => setHomepageSettings(s)).catch(console.error);
  }, []);
      ...
      <section className="hero-section">
        <Slider {...settings} className="banner-slider banner-sec owl-carousel">
          <div className="slider-img">
            <ImageWithBasePath
              src={homepageSettings?.heroImage || "assets/img/banner/banner-01.jpg"}
              alt="Hero banner"
              fallbackSrc={getCategoryFallbackSrc("homepage")}
            />
          </div>
          <div className="slider-img">
            <ImageWithBasePath
          ...
          <div className="slider-img">
            <ImageWithBasePath
              src="assets/img/banner/banner-04.jpg"
              alt="Img"
            />
          </div>
        </Slider>
        <div className="container">
          <div className="hero-content">
            <div className="row align-items-center">
              <div
                className="col-md-12 mx-auto aos fadeInUp"
                data-aos="fade-up"
              >
                <div className="banner-content mx-auto">
                  <h1 className="text-white display-5 mb-2">
                    {homepageSettings?.heroTitle || "Get Closer to the Dream: Your Tour Essentials Await"}
                  </h1>
                  <h6 className="text-light mx-auto">
                    {homepageSettings?.heroSubtitle || "Your ultimate destination for all things help you celebrate & remember tour experience."}
                  </h6>
                </div>
                    ...
                    <ul className="nav">
                      ...
                      <li>
                        <Link
                          ...
                          data-bs-target="#Bus"
                        >
                          <i className="isax isax-bus me-2" />
                          Bus
                        </Link>
                      </li>
                      <li>
                    ...
                    <div>
                      <div className="tab-content">
                        ...
                        <div className="tab-pane fade" id="Hotels">
                          <form>
                            <div className="fw-medium fs-16 mb-2 text-center text-dark">
                        ...
                        <div className="tab-pane fade" id="Cruise">
                          <form>
                            <div className="d-flex align-items-center justify-content-between flex-wrap mb-2">
                              <div className="fw-medium fs-16 mb-2 text-dark">
                                Search For Cruise
                              </div>
                            </div>
                            <div className="d-lg-flex">
