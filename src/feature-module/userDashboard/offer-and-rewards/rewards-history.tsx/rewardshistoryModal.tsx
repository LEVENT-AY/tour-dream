...
const RewardshistoryModal = () => {
  return (
    <>
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h5>
                ...
                <span className="fs-14 fw-medium text-primary">#RH-1245</span>
              </h5>
            ...
            <div className="modal-body">
              <div className="upcoming-content">
                ...
                <div className="upcoming-details ">
                  <h6 className="mb-3">Rewards History Details</h6>
                  <div className="row gy-3">
                    ...
                    <div className="col-lg-4">
                      <h6 className="fs-14">Reward Type</h6>
                      <p className="text-gray-6 fs-16 ">Loyalty Points</p>
                    </div>
                    <div className="col-lg-4">
      ...
      {/* /Coupon Info */}
      {/* Coupon Info */}
      <div className="modal fade" id="expired">
        <div className="modal-dialog  modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <h5>
