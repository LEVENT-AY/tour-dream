...
import { UserBusBookingData } from '../../../../core/common/data/json/userBusBookingData';
import PredefinedDateRanges from '../../../../core/common/range-picker/datePicker';
import UserBusBookingModal from './userBusBookingModal';

const UserBusBooking = () => {

  const data = UserBusBookingData;
  const columns = [
    {
      title: "ID",
      dataIndex: "id",
