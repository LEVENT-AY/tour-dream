...
import { changeAgentPassword } from '../../../../core/services/agentServices';
                    ...
                    <div className="modal-content">
                        ...
                        <form onSubmit={handlePasswordSubmit}>
                            <div className="modal-body pb-0">
                                {pwdMessage && (
                                    <div className={`alert ${pwdMessage.includes('success') ? 'alert-success' : 'alert-danger'} alert-dismissible fade show`} role="alert">
                                        {pwdMessage}
                                        <button type="button" className="btn-close" onClick={() => setPwdMessage('')} aria-label="Close" />
                                    </div>
                                )}
                                <div className="mb-3">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="submit" className="btn btn-primary btn-md" disabled={pwdLoading}>
