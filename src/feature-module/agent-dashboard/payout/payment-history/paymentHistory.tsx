          ...
          <div className="row">
            ...
            <div className="col-xl-9 col-lg-8 theiaStickySidebar">
              ...
              <div className="d-flex align-items-center flex-wrap gap-2 mb-3">
                <Link to={routes.agentPendingPayouts} className="btn btn-light">
                  Pending Payouts
                </Link>
                <Link to={routes.agentPaymentHistory} className="btn btn-primary">
                  Payment History
                </Link>
              </div>
              ...
              <div className="card hotel-list">
                <div className="card-body p-0">
                  <div className="list-header d-flex align-items-center justify-content-between flex-wrap">
                    <h6 className="">Payment History</h6>
                  </div>
                  <div className="p-4 text-center">
                    <div className="alert alert-info d-inline-block mb-0">
                      <i className="isax isax-info-circle5 me-2" />
                      Payment and payout integration is not configured yet. Completed payouts will appear here once payout processing is enabled.
                    </div>
                  </div>
                </div>
              </div>
