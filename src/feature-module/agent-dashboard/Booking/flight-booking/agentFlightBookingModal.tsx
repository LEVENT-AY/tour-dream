...
interface AgentFlightBookingModalProps {
    booking?: Booking | null;
}

const AgentFlightBookingModal = ({ booking }: AgentFlightBookingModalProps) => {
                ...
                <div className="upcoming-content">
                    <div className="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                        <div className="d-flex align-items-center flex-wrap">
                            <div className="me-2">
                                <ImageWithBasePath
                                    src={booking?.itemImage || "assets/img/flight/flight-01.jpg"}
                                    alt="image"
                                    className="avatar avartar-md avatar-rounded"
                                    fallbackSrc="assets/img/flight/flight-01.jpg"
                                />
                            </div>
                            <div>
                                <h6 className="mb-1">{booking?.itemTitle || 'Flight'}</h6>
                            </div>
                        </div>
                        <div>
                    ...
                    <div className="upcoming-details ">
                        ...
                        <div className="row gy-3">
                            ...
                            <div className="col-lg-3">
                                <h6 className="fs-14">Departure</h6>
