...
const AgentVisaBooking = () => {
    ...
    const loadBookings = async () => {
        ...
        try {
            ...
            setBookings(data.filter((b) => b.itemType === 'visa'));
        } catch (err) {
    ...
    const data = bookings.map((booking) => {
        ...
        return {
            ...
            visaName: booking.itemTitle || '—',
            visaType: booking.itemType || '—',
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_text: any, render: any) => (
                <div>
                    <p className="text-dark mb-0 fw-medium fs-14">{render.visaName}</p>
                    <span className="fs-14 fw-normal text-gray-6">{render.visaType}</span>
                </div>
            ),
            sorter: (a: any, b: any) => String(a.visaName).length - String(b.visaName).length,
        },
        {
            title: "Booked By",
            dataIndex: "bookedBy",
    ...
    return (
        <div>
            <Breadcrumb title="Visa Bookings" breadcrumbs={breadcrumbs} backgroundClass="breadcrumb-bg-04" />
                        ...
                        <div className="col-xl-9 col-lg-8 theiaStickySidebar">
                            <div className="card booking-header border-0">
                                <div className="card-body header-content d-flex align-items-center justify-content-between flex-wrap">
                                    <div>
                                        <h6 className="mb-1">Visa Bookings</h6>
