        ...
        <>
            ...
            >
                ...
                <div className="modal-content">
                    ...
                    <h5>
                        Booking Info{" "}
                        <span className="fs-14 fw-medium text-primary">#BB-1245</span>
                    </h5>
                    <Link
                        to="#"
                    ...
                    <div className="upcoming-content">
                        ...
                        <div className="d-flex align-items-center flex-wrap">
                            ...
                            <div>
                            <h6 className="mb-1">Red Bird Luxury</h6>
                        ...
                        <div className="row gy-3">
                            ...
                            <h6 className="fs-14">Type</h6>
                            <p className="text-gray-6 fs-16 ">Sleeper</p>
                            </div>
                            <div className="col-lg-3">
                            <h6 className="fs-14">From</h6>
                            <p className="text-gray-6 fs-16 ">Chicago</p>
                            </div>
                            <div className="col-lg-3">
                            <h6 className="fs-14">To </h6>
                            <p className="text-gray-6 fs-16 ">Miami</p>
                            </div>
                            <div className="col-lg-3">
            ...
            >
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                    <Link to={all_routes.busDetails} className="btn btn-md btn-primary">
                        Book Again
                    </Link>
                    </div>
                </div>
                ...
                <div className="modal-content">
                    ...
                    <form>
                        ...
                        <p className="mb-4 text-gray-9">
                            Order ID : <span className="text-primary">#BB-1245</span>
                        </p>
                        </div>
                        <div className="mb-4">
...
export default AgentBusBookingModal
