...
const AgentTourBooking = () => {
    ...
    const loadBookings = async () => {
        ...
        try {
            ...
            setBookings(data.filter((b) => b.itemType === 'tour'));
        } catch (err) {
    ...
    const data = bookings.map((booking) => {
        ...
        return {
            ...
            tourName: booking.itemTitle,
            tourType: booking.itemType,
    ...
    const columns = [
        ...
        },
        {
            ...
            sorter: (a: TableData, b: TableData) =>
                String((a as any).tourName).length - String((b as any).tourName).length,
        },
        {
            title: "Booked By",
            dataIndex: "bookedBy",
    ...
    return (
        <div>
                            ...
                            <div className="card hotel-list">
                                <div className="card-body p-0">
                                    ...
                                    {loading ? (
                                        ...
                                        <div className="text-center py-5">
                                            <h6>No tour bookings found</h6>
                                            <p className="text-muted mb-0">Tour bookings assigned to you will appear here.</p>
                                        </div>
                                    ) : (
            ...
            {/* /Page Wrapper */}
            <AgentTourBookingModal booking={selectedBooking} />
