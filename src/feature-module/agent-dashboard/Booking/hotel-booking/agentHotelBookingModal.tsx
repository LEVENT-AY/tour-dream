...
interface AgentHotelBookingModalProps {
    booking?: Booking | null;
}

const AgentHotelBookingModal = ({ booking }: AgentHotelBookingModalProps) => {
                ...
                <div className="upcoming-content">
                    <div className="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
                        <div className="d-flex align-items-center flex-wrap">
                            <div className="me-2">
                                <ImageWithBasePath
                                    src={booking?.itemImage || "assets/img/hotels/hotel-13.jpg"}
                                    alt="image"
                                    className="avatar avartar-md avatar-rounded"
                                    fallbackSrc="assets/img/hotels/hotel-13.jpg"
                                />
                            </div>
                            <div>
                                <h6 className="mb-1">{booking?.itemTitle || 'Hotel'}</h6>
                            </div>
                        </div>
                        <div>
                    ...
                    <div className="upcoming-details">
                        ...
                        <div className="row gy-3">
                            ...
                            <div className="col-lg-3">
                                <h6 className="fs-14">Check In</h6>
                                <p className="text-gray-6 fs-16 ">{formatDate(booking?.checkInDate || booking?.startDate)}</p>
                            </div>
                            <div className="col-lg-3">
                                <h6 className="fs-14">Check Out</h6>
                                <p className="text-gray-6 fs-16 ">{formatDate(booking?.checkOutDate || booking?.endDate)}</p>
                            </div>
                            <div className="col-lg-3">
