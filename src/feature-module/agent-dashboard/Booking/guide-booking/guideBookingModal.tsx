    ...
    <div className="modal-dialog  modal-dialog-centered modal-xl">
      <div className="modal-content">
        <div className="modal-header">
          <h5>
            Booking Info{" "}
            <span className="fs-14 fw-medium text-primary">#GB-1245</span>
          </h5>
          ...
          <div className="upcoming-content">
            <div className="upcoming-title mb-4 d-flex align-items-center justify-content-between p-3 rounded">
              <div className="d-flex align-items-center flex-wrap">
                ...
                <div>
                  <h6 className="mb-1">Micheal John</h6>
            ...
            <div className="upcoming-details ">
              ...
              <div className="row gy-3">
                ...
                <div className="col-lg-3">
                  ...
                  <p className="text-gray-6 fs-16 ">28 Oct 2026</p>
                </div>
                <div className="col-lg-3">
            ...
            <div className="upcoming-details">
              ...
              <div className="d-flex">
                <Link to="#" className="btn btn-light rounded-pill me-2">
                  Sightseeing
                </Link>
...
export default AgentGuideBookingModal
