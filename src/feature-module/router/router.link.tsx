...
import AdminGuides from "../admin-dashboard/pages/guides";
import AdminServiceRequests from "../admin-dashboard/pages/serviceRequests";
...
export const adminRoutes = [
  ...
  { path: routes.adminGuides, element: <AdminGuides />, route: Route },
  { path: routes.adminServiceRequests, element: <AdminServiceRequests />, route: Route },
